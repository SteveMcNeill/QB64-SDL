...
extern double func_grad2deg(double value);
extern double func_rad2grad(double value);
extern double func_grad2rad(double value);
...
extern int32 func__autodisplay ();
extern int64 func__handle();
